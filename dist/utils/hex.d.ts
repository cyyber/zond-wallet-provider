...
export declare const StrictHexStruct: Struct<Hex, null>;
export declare const HexAddressStruct: Struct<Hex, null>;
export declare const HexChecksumAddressStruct: Struct<Hex, null>;
/**
