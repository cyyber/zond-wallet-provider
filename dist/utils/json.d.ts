import { Infer, ObjectSchema, Optionalize, Simplify, Struct } from '../superstruct';
 ...
 */
export declare const object: <Schema extends ObjectSchema>(schema: Schema) => Struct<ObjectType<Schema>>;
...
export declare const JsonRpcErrorStruct: Struct<{
    ...
    data?: (Json & ExactOptionalGuard) | undefined;
    message: string;
    code: number;
}, unknown>;
/**
...
export declare const JsonRpcRequestStruct: Struct<{
    params?: ((Json[] | Record<string, Json>) & ExactOptionalGuard) | undefined;
 ...
 */
export type JsonRpcRequest<Params extends JsonRpcParams = JsonRpcParams> = InferWithParams<typeof JsonRpcRequestStruct, Params> & AdditionalJsonRpcRequestKeys;
