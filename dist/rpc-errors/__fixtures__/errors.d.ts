...
export declare const dummyDataWithCause: {
    foo: string;
    cause: {
        message: string;
    };
...
export declare const validError2: import('..').JsonRpcError<import('..').OptionalDataWithOptionalCause>;
export declare const validError3: import('..').JsonRpcError<import('..').OptionalDataWithOptionalCause>;
